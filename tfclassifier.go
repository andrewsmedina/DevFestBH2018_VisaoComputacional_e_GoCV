...
func main() {
	if len(os.Args) < 4 {
		fmt.Println("How to run:\n go run tf-classifier.go [camera ID] [modelfile] [descriptionsfile]")
		return
	}
...
//
// 		go run tfclassifier.go 0 ~/tensorflow_inception_graph.pb ~/imagenet_comp_graph_label_strings.txt opencv cpu
//
